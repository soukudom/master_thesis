...
produ na Ukrajině, který měl dopad na 225 000 zákazníků \cite{ukraine}. 

Pro potlačení možného vzniku hrozeb musí být součástí každné dnešní IoT sítě sada procesů,
...
\chapter{Návrh}
Kapitola se zabývá návrhem způsobu detekce anomálií v IoT sítích, které s pomocí NEMEA
systému rozšiřuje bránu BeeeOn. Nejprve je popsána celková architektura a
možné způsoby nasazení. Dále jsou popsány jednotlivé komponenty detekčního systému.
