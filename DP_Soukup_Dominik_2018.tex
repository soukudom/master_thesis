...
\section{Mux a Demux}    
     % posat nastavení vstupních argumentů     
...
testovací prostředí. Dále prověřeny obě možné metody nasazení. V závěru jsou ověreny jednotlivé 
případy hrozeb z kapitoly \ref{utoky} Scénáře útoků a také jsou otestovány ostatní funkcionality
detektoru.
