...
provozu senzorových protokolů v rámci BeeeOn brány. Při popisu byla množina infomací rozdělena
...
\begin{itemize}
 ...
 \item \textbf{readCount}
 \item \textbf{writeCount}:
 \item \textbf{CANCount}:
 \item \textbf{NAKCount}:
 \item \textbf{ACKCount}:
 \item \textbf{OOFCount}:
 ...
 \item \textbf{badroutes}
 \item \textbf{noACK}:
 \item \textbf{netBusy}:
 \item \textbf{notIdle}:
 \item \textbf{nonDelivery}:
 \item \textbf{routedBusy}:
 \item \textbf{broadcastReadCount}:
 \item \textbf{broadcastWriteCount}:
\end{itemize}

\section{onNodeStats}
\begin{itemize}
 \item \textbf{sentCount}:
 \item \textbf{sentFailed}:
 \item \textbf{receivedCount}:
 \item \textbf{receivedDuplications}:
 \item \textbf{receivedUnsoliced}:
 \item \textbf{lastRequestRTT}:
 \item \textbf{lastResponseRTT}:
 \item \textbf{averageRequestRTT}:
 \item \textbf{averageResponseRTT}:
 \item \textbf{quality}:
 \item \textbf{nodeID}:
\end{itemize}
...
\begin{itemize}
 \item \textbf{address}:
 \item \textbf{aclPackets}:
 \item \textbf{scoMtu}:
 \item \textbf{scoPackets}:
 \item \textbf{rxErrors}:
 \item \textbf{txErrors}:
 \item \textbf{rxEvents}:
 \item \textbf{txCmds}:
