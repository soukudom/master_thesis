...
\end{itemize}
 ...
 neexistuje řešení, které by to umožňovalo. Algoritmus bude umístěň přímo na IoT bráně, která 
 je velmi blízko koncovým zařízením a má dostatečný výkon k vyhodnocování provozu. 
 ...
 Vyhodnocování dat bude probíhat metodou detekce anomálií, která je vhodnější statistickou povahu dat
 s velkým důrazem na úsporu dostupných prostředků.
 že bude pokryt jen z-wave a ble, možná ještě někam strčit nemea
 
 
 prg jazy je C++ - efektivita, podpora
 anomaly based detection
 konfigurační soubor
 Brána BeeeOn s NEMEA
 výběr metody provozních statistik pro BLE a z-wave
